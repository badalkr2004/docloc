...
import { RiSearchLine, RiAddLine, RiCheckLine, RiInboxArchiveLine } from '@remixicon/react';
  ...
  return (
    <div className="flex flex-col h-full bg-background border-r">
      <div className="p-4 border-b">
        <h3 className="font-medium text-sm mb-3">Vault Documents</h3>
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  className="h-8 w-8 sm:w-auto sm:px-3 flex-shrink-0"
